...
func NewClaudeAIProvider(cfg *config.Config) *ClaudeAIProvider {
...
func (c *ClaudeAIProvider) Login() (string, time.Time, error) {
...
func (c *ClaudeAIProvider) GetOrganizations() ([]provider.Organization, error) {
...
func (c *ClaudeAIProvider) GetProjects(organizationID string, includeArchived bool) ([]provider.Project, error) {
...
func (c *ClaudeAIProvider) ListFiles(organizationID, projectID string) ([]provider.File, error) {
...
func (c *ClaudeAIProvider) UploadFile(organizationID, projectID, fileName, content string) error {
	url := fmt.Sprintf("/organizations/%s/projects/%s/docs", organizationID, projectID)
...
func (c *ClaudeAIProvider) DeleteFile(organizationID, projectID, fileUUID string) error {
	url := fmt.Sprintf("/organizations/%s/projects/%s/docs/%s", organizationID, projectID, fileUUID)
	_, err := c.makeRequest("DELETE", url, nil)
	return err
}

func (c *ClaudeAIProvider) ArchiveProject(organizationID, projectID string) error {
...
func (c *ClaudeAIProvider) CreateProject(organizationID, name, description string) (provider.Project, error) {
	url := fmt.Sprintf("/organizations/%s/projects", organizationID)
...
func (c *ClaudeAIProvider) GetChatConversations(organizationID string) ([]provider.ChatConversation, error) {
...
func (c *ClaudeAIProvider) GetPublishedArtifacts(organizationID string) ([]provider.PublishedArtifact, error) {
...
func (c *ClaudeAIProvider) GetChatConversation(organizationID, conversationID string) (provider.ChatConversation, error) {
...
func (c *ClaudeAIProvider) GetArtifactContent(organizationID, artifactUUID string) (string, error) {
...
func (c *ClaudeAIProvider) DeleteChat(organizationID string, conversationUUIDs []string) error {
...
func (c *ClaudeAIProvider) CreateChat(organizationID, chatName, projectUUID string) (provider.ChatConversation, error) {
	url := fmt.Sprintf("/organizations/%s/chat_conversations", organizationID)
	data := map[string]string{
		"name":         chatName,
...
func (c *ClaudeAIProvider) SendMessage(organizationID, chatID, prompt, timezone string) (<-chan provider.MessageEvent, error) {
...
func (c *ClaudeAIProvider) makeRequest(method, endpoint string, data interface{}) (*http.Response, error) {
...
func (c *ClaudeAIProvider) getSessionKey() string {
